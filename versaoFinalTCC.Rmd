...
ggplot(Alameda)+
aes(Excesso)+
geom_histogram(binwidth=1, fill = '#eed600', bins = 50)+
labs(y = 'Quantidade')+
...
ggplot(Shopping)+
aes(Excesso)+
geom_histogram(binwidth=1, fill = '#0038ee', bins = 50)+
labs(y = 'Quantidade')+
theme(axis.title.y = element_text(size = 15, family = "Nunito",
                                    margin = margin(r = 7)),
        axis.title.x = element_text(size = 15, family = "Nunito",
...
ggplot(Maranhao)+
aes(Excesso)+
geom_histogram(binwidth=1, fill = '#00ee28', bins = 50)+
labs(y = 'Quantidade')+
theme(axis.title.y = element_text(size = 15, family = "Nunito",
                                    margin = margin(r = 7)),
        axis.title.x = element_text(size = 15, family = "Nunito",
...
ggplot(Barao)+
aes(Excesso)+
geom_histogram(binwidth=1, fill = '#ee00ab')+
labs(y = 'Quantidade')+
theme(axis.title.y = element_text(size = 15, family = "Nunito",
                                    margin = margin(r = 7)),
        axis.title.x = element_text(size = 15, family = "Nunito",
...
\tab Outro teste que podemos realizar é o de Kruskal White, com ele iremos analisar a distribuição dos quatro radares buscando definir se o comportamento é parecido ou não. Se o resultado indicar que existe diferença, utilizaremos um pós-teste (Teste de Dunn) para identificar entre quais ocorrem a diferença.
...
geom_boxplot()+
scale_fill_manual(breaks = origem, values = c('#eed600','#0038ee', '#00ee28', '#ee00ab'))+
