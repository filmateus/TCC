...
possuem ficam mais difíceis de prever. Em (\textbf{PINHEIRO?}), podemos
...
\caption{Av. dos Ipês - Função fggpd}\label{fig:unnamed-chunk-26}
\end{figure}
...
\caption{Av. dos Ipês - Função fmgpd}\label{fig:unnamed-chunk-27}
\end{figure}
...
\caption{Av. Jose - Função fggpd}\label{fig:unnamed-chunk-29}
\end{figure}
...
\caption{Av. Jose - Função fmgpd}\label{fig:unnamed-chunk-30}
\end{figure}
...
\caption{Av. Barão - Função fggpd}\label{fig:unnamed-chunk-32}
\end{figure}
\begin{figure}
...
\caption{Av. Barão - Função fmgpd}\label{fig:unnamed-chunk-33}
\end{figure}
...
(\textbf{article?})\{(\textbf{BRAGA?}), title = \{Aplicação da Teoria de
Valores Extremos para índice pluviométrico da cidade de Juiz de Fora -
MG\}, author = \{BRAGA, D. O. M.,\}, adress = \{Juiz de Fora, MG\}, year
=\{2015\} \}

(\textbf{article?})\{(\textbf{LIMA?}), title = \{Modelos Dinâmicos para
valores extremos de dados ambientais do Piauí usando a Distribuição de
Pareto Generalizada (GPD)\} author = \{Stênio Rodrigues Lima\}, adress =
\{Teresina, PI\}, year = \{2014\} \}

(\textbf{article?})\{(\textbf{NASCIMENTO?}), title = \{MODELOS
PROBABILíSTICOS PARA DADOS EXTREMOS:TEORIA E APLICAÇÕES\}, author =
\{NASCIMENTO, F, F.\}, adress = \{Teresina, PI\}, year = \{2012\} \}

(\textbf{article?})\{(\textbf{PINHEIRO?}), title = \{Contribuições em
inferência e modelagem de valores extremos\}, author = \{PINHEIRO, E,
C.\}, address = \{São Paulo, SP\}, year = \{2014\} \}
