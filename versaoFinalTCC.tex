...
fim de registro de infração, não se utiliza a velocidade obtida pelo
instrumento de medição, mas subtrai-se um valor na velocidade medida
...
registrando um excesso de 1km/h, mas para uma velocidade registrada de
67 km/h, o valor considerado é de 60km/h. O resultado dessa distinção é
o uso de dois termos: Velocidade medida, que consiste na velocidade
registrada e Velocidade Considerada, que é a velocidade medida menos o
fator de correção. Na tabela abaixo, temos a relação entre velocidade
medida e velocidade considerada. A infração é feita quando a considerada
é maior que permitida na via.
...
todas os registros realizados, independente se o auto não foi expedido
...
se o comportamento é parecido ou não. Se o resultado indicar que existe
diferença, utilizaremos um pós-teste (Teste de Dunn) para identificar
entre quais ocorrem a diferença.
